...
- Nach 2.0.0 (ohne Release-Druck): ~~npm-Hauptversionen~~ (erledigt 08.09.2026: react-router 7, TipTap 3, vite 8, Node 22, `npm audit` 0), K-26 — Prüfbericht: [docs/PRUEFBERICHT-NPM-2026-09-08.md](docs/PRUEFBERICHT-NPM-2026-09-08.md); K-26a gemergt 09.09.2026 (Verkauf aufgeteilt, v2.0.2), K-26a2 gemergt 09.09. (v2.0.3, Windows-Test offen), K-26b gemergt (PR #94) und am Server abgenommen 10.09. (v2.0.4), K-26c gebaut 11.09. (Request-ID im Log, raise from, SEC-015; v2.0.5) — Prüfbericht: [docs/PRUEFBERICHT-K26C-2026-09-11.md](docs/PRUEFBERICHT-K26C-2026-09-11.md); R1-Reload-Test beim Deploy beobachten — Prüfbericht: [docs/PRUEFBERICHT-K26B-2026-09-09.md](docs/PRUEFBERICHT-K26B-2026-09-09.md) — Prüfbericht: [docs/PRUEFBERICHT-K26A-2026-09-08.md](docs/PRUEFBERICHT-K26A-2026-09-08.md)
